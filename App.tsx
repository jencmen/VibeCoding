        ...
        <div className="lg:col-span-8 space-y-12">
          ...
          <section className="bg-white p-10 rounded-[3rem] border border-gray-100 shadow-xl relative overflow-hidden">
            <div className="relative z-10">
              <div className="inline-block px-3 py-1 mb-6 text-[10px] font-bold tracking-widest text-indigo-600 uppercase bg-indigo-50 rounded-lg border border-indigo-100">
                פרק ג': המנוע והכלים
              </div>
              
              <div className="grid grid-cols-1 xl:grid-cols-12 gap-12">
                {/* Left side (The Vibe Matrix - Larger focus) */}
                <div className="xl:col-span-7 bg-slate-50/50 p-8 rounded-[2.5rem] border border-gray-100 shadow-inner relative" dir="ltr">
                  ...
                  <div className="relative h-[400px] w-full border-l-2 border-b-2 border-gray-300 ml-4 mb-10">
                    ...
                    {/* Tool Clusters based on new image */}
                    
                    {/* TOP RIGHT: Power + Technical */}
                    ...
                    {/* TOP CENTER: Power + Mid Technical */}
                    ...
                    <div className="absolute bottom-[72%] left-[38%]">
                       <span className="text-[9px] font-bold text-gray-400 italic">Mocha</span>
                    </div>
                    ...
                    <div className="absolute bottom-[68%] left-[41%] flex items-center gap-1">
                       <div className="w-2.5 h-2.5 bg-purple-500 rounded-full flex items-center justify-center text-[6px] text-white">d</div>
                       <span className="text-[9px] font-bold text-gray-500">Dyad</span>
                    </div>

                    {/* BOTTOM LEFT: Low Power + Less Technical */}
                    ...
                    <div className="absolute bottom-[20%] left-[35%] w-8 h-8 bg-white rounded-full shadow-sm flex items-center justify-center border border-gray-100">
                       <span className="text-gray-300 font-serif">A</span>
                    </div>

                    {/* The Cursor Pointer - Positioned as a focal point */}
          ...
          {/* Chapter 4: The Detailed Results Analysis */}
          <section className="bg-white p-10 rounded-[3rem] border border-gray-100 shadow-sm">
            <div className="inline-block px-4 py-1 mb-6 text-[10px] font-bold tracking-widest text-emerald-600 uppercase bg-emerald-50 rounded-lg border border-emerald-100">
            ...
            <div className="space-y-6">
              ...
              <div className="p-8 bg-emerald-50 rounded-3xl border-2 border-emerald-200 relative overflow-hidden">
                ...
                <p className="text-emerald-800 leading-relaxed">
                  זו הגישה שסיפקה את ה-MVP הטוב ביותר. על ידי הזנת ה-Core תחילה ואז הרחבת יכולות (Iterative Feeding), המודל שמר על הקשר (Context) נקי והצליח ליישם לוגיקה מורכבת ללא טעויות. זהו העתיד של ה-PM האוטונומי.
                </p>
              </div>
            </div>
